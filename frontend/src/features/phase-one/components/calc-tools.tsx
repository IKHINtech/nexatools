    ...
    <>
      <ToolCard title="Basic Calculator" description="Add, subtract, multiply, divide, and exponentiate numeric values.">
        <div className="grid gap-4 md:grid-cols-[1fr_1fr_1fr_auto]">
          <Field label="X"><Input value={basicCalc.x} onChange={(e) => setState((prev) => ({ ...prev, basicCalc: { ...prev.basicCalc, x: e.target.value } }))} className="border-stone-300 bg-white" /></Field>
          ...
          <Field label="Y"><Input value={basicCalc.y} onChange={(e) => setState((prev) => ({ ...prev, basicCalc: { ...prev.basicCalc, y: e.target.value } }))} className="border-stone-300 bg-white" /></Field>
      ...
      <ToolCard title="Unit Converter" description="Length, weight, and temperature all route through the same backend converter.">
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <Field label="Value"><Input value={unitCalc.value} onChange={(e) => setState((prev) => ({ ...prev, unitCalc: { ...prev.unitCalc, value: e.target.value } }))} className="border-stone-300 bg-white" /></Field>
          <Field label="From"><Input value={unitCalc.from} onChange={(e) => setState((prev) => ({ ...prev, unitCalc: { ...prev.unitCalc, from: e.target.value } }))} className="border-stone-300 bg-white" /></Field>
          <Field label="To"><Input value={unitCalc.to} onChange={(e) => setState((prev) => ({ ...prev, unitCalc: { ...prev.unitCalc, to: e.target.value } }))} className="border-stone-300 bg-white" /></Field>
        </div>
      ...
      <ToolCard title="Percentage / Date / Timestamp / Base" description="Grouped because these are small calculators with distinct output types.">
        <div className="grid gap-6">
          <div className="grid gap-4 md:grid-cols-4">
            ...
            <Field label="X"><Input value={percentageCalc.x} onChange={(e) => setState((prev) => ({ ...prev, percentageCalc: { ...prev.percentageCalc, x: e.target.value } }))} className="border-stone-300 bg-white" /></Field>
            <Field label="Y"><Input value={percentageCalc.y} onChange={(e) => setState((prev) => ({ ...prev, percentageCalc: { ...prev.percentageCalc, y: e.target.value } }))} className="border-stone-300 bg-white" /></Field>
          ...
          <div className="grid gap-4 md:grid-cols-4">
            <Field label="Start date"><Input value={dateCalc.start} onChange={(e) => setState((prev) => ({ ...prev, dateCalc: { ...prev.dateCalc, start: e.target.value } }))} className="border-stone-300 bg-white" /></Field>
            <Field label="End date"><Input value={dateCalc.end} onChange={(e) => setState((prev) => ({ ...prev, dateCalc: { ...prev.dateCalc, end: e.target.value } }))} className="border-stone-300 bg-white" /></Field>
            <Field label="Date"><Input value={dateCalc.date} onChange={(e) => setState((prev) => ({ ...prev, dateCalc: { ...prev.dateCalc, date: e.target.value } }))} className="border-stone-300 bg-white" /></Field>
            <Field label="Days"><Input value={dateCalc.days} onChange={(e) => setState((prev) => ({ ...prev, dateCalc: { ...prev.dateCalc, days: e.target.value } }))} className="border-stone-300 bg-white" /></Field>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <Field label="Unix timestamp"><Input value={dateCalc.timestamp} onChange={(e) => setState((prev) => ({ ...prev, dateCalc: { ...prev.dateCalc, timestamp: e.target.value } }))} className="border-stone-300 bg-white" /></Field>
            <Field label="ISO datetime"><Input value={dateCalc.iso} onChange={(e) => setState((prev) => ({ ...prev, dateCalc: { ...prev.dateCalc, iso: e.target.value } }))} className="border-stone-300 bg-white" /></Field>
          ...
          <div className="grid gap-4 md:grid-cols-4">
            <Field label="Number"><Input value={dateCalc.baseInput} onChange={(e) => setState((prev) => ({ ...prev, dateCalc: { ...prev.dateCalc, baseInput: e.target.value } }))} className="border-stone-300 bg-white" /></Field>
            <Field label="From base"><Input value={dateCalc.fromBase} onChange={(e) => setState((prev) => ({ ...prev, dateCalc: { ...prev.dateCalc, fromBase: e.target.value } }))} className="border-stone-300 bg-white" /></Field>
            <Field label="To base"><Input value={dateCalc.toBase} onChange={(e) => setState((prev) => ({ ...prev, dateCalc: { ...prev.dateCalc, toBase: e.target.value } }))} className="border-stone-300 bg-white" /></Field>
